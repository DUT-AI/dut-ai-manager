...
import type { HomeworkSubmission, ScoreDetail } from '@/features/homework/types/homework.types';
        ...
        >
            {isLoading ? (
                ...
                <div style={{ wordBreak: 'break-word', marginTop: 16 }}>
                    ...
                    {activeSubmission?.scores && Array.isArray(activeSubmission.scores) && activeSubmission.scores.length > 0 && (
                        <div style={{ marginBottom: 24 }}>
                            <Title level={5}>Chi tiết điểm</Title>
                            <Table<ScoreDetail>
                                dataSource={activeSubmission.scores}
                                columns={columns}
                                rowKey="criterion"
                                pagination={false}
                                size="small"
