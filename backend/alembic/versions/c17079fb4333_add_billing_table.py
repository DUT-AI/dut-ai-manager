...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_invoices_reference_code"), "invoices", ["reference_code"], unique=True
    )
    op.create_index(op.f("ix_invoices_status"), "invoices", ["status"], unique=False)
    op.create_index(
        op.f("ix_invoices_transaction_id"), "invoices", ["transaction_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_invoice_items_created_at"),
        "invoice_items",
        ["created_at"],
        unique=False,
    )
