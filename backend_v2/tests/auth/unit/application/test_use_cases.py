...
from app.auth.domain.exceptions import InvalidCredentialsException, UserInactiveException
...
@pytest.mark.asyncio
async def test_login_success(login_use_case, mock_hasher, mock_token_service, mock_auth_query):
    # Setup
