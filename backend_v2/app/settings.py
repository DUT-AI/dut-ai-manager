...
# Lấy đường dẫn gốc của project dut-ai-manager
...
class DiscordBotSettings(Settings):
    # Discord Bot Configuration
    DISCORD_BOT_TOKEN: str = ""
    DISCORD_PERMISSION_ROOM_ID: str = ""


class CORSSetting(Settings):
    ...
    def all_cors_origins(self) -> list[str]:
        ...
        BACKEND_CORS_ORIGINS = parse_cors(self.BACKEND_CORS_ORIGINS)
        return [str(origin).rstrip("/") for origin in BACKEND_CORS_ORIGINS] + [
            self.FRONTEND_HOST
        ]


class SMTPSetting(Settings):
...
class ZaloBotSettings(Settings):
